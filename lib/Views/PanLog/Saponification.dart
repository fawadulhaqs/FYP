...
class Saponifiaction extends StatefulWidget {
  const Saponifiaction({Key? key}) : super(key: key);

  @override
  State<Saponifiaction> createState() => _SaponifiactionState();
}

class _SaponifiactionState extends State<Saponifiaction> {
  final collectiveController = Get.put(LogController());

  @override
  Widget build(BuildContext context) {
    int sapActual = collectiveController.sapDiff;
                    ...
                    children: [
                      ...
                      DropdownButtonFormField(
                        ...
                        validator: (value) => value == null
                            ...
                            : null,
                        onChanged: (val) {
                          collectiveController.sapLossesValue.value =
                              val.toString();
                        },
                      ),
                    ],
